...
Route::group(['middleware' => ['auth', 'laralum.base'], 'prefix' => 'administrator'], function(){
	Route::get('/', 'AdministrationController@index')->name('administration');
	Route::get('/printer/{id}', 'AdministrationController@printer')->name('printer_info');
	Route::get('/printer/{id}/enable', 'AdministrationController@enablePrinter')->name('enable_printer');
	Route::get('/printer/{id}/disable', 'AdministrationController@disablePrinter')->name('disable_printer');
	Route::post('/printer/{id}', 'AdministrationController@addWarning');
});
